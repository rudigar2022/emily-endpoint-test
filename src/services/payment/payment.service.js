...
let PaymentService = class PaymentService {
    ...
    synchronizeReceipts(receipts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.databaseService.executeDatabaseObject(`[${Configurations.database.databaseSchema}].[CreateReceipts]`, [parameter]);
            return response;
        });
    }
    /**
    ...
    synchronizeCreditNotes(creditNotes) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.databaseService.executeDatabaseObject(`[${Configurations.database.databaseSchema}].[CreateCreditNotes]`, [parameter]);
            return response;
        });
    }
};
