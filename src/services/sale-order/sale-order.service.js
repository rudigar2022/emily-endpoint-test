...
let SaleOrderService = class SaleOrderService {
     ...
     */
    synchronizeSalesOrders(salesOrders) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.databaseService.executeDatabaseObject(`[${Configurations.database.databaseSchema}].[CreateSalesOrders]`, [parameter]);
            return response;
        });
    }
};
